 ...
 * and a named embedding store. {@link dev.ericdeandrea.docling.ai.ingestion.IngestionStartup}
...
public interface IngestionPipeline {
    ...
    /** The named embedding store key, derived from {@link Mode#storeName()} by default. */
    default String storeName() {
        return mode().storeName();
    }

    /** Whether this pipeline's embedding store already contains data. */
