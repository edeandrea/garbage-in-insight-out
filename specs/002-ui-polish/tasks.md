...
- [ ] 1. **Decompose ChatPanel into a plain coordinator class ([req 6](spec.md#requirements))**
...
- [ ] 2. **Restructure ChatView with SplitLayout ([req 6](spec.md#requirements))**
...
- [ ] 3. **Update existing tests for decomposition (reqs 6)**
...
- [ ] 6. **Add row color coding ([req 1](spec.md#requirements))**
...
- [ ] 9. **Sticky toolbar ([req 7](spec.md#requirements))**
...
- [ ] 10. **Add new SplitLayout and layout tests ([req 6](spec.md#requirements))**
