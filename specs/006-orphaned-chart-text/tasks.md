...
- [ ] 1. **Refactor `captionTextFor` to accept `List<RefItem>` ([req 2](spec.md#requirements))**
...
- [ ] 2. **Add `orphanedChildrenOf` to DocItemIndex ([req 1](spec.md#requirements))**
...
- [ ] 3. **Create synthetic picture segments in `extractAndChunk()` ([req 2](spec.md#requirements))**
...
- [ ] 4. **Add integration test for synthetic picture segments ([req 3](spec.md#requirements))**
...
- [ ] 5. **Browser verification ([req 3](spec.md#requirements))**
