...
- [ ] 1. **Update CaptureDoclingResponsesTest and re-capture WireMock stub ([req 3](spec.md#requirements))**
...
- [ ] 2. **Create DocItemIndex ref resolution utility**
...
- [ ] 3. **Fix Mode B `elementLabel` in DoclingExtractor ([req 1](spec.md#requirements))**
...
- [ ] 4. **Update Mode B tests ([req 1](spec.md#requirements))**
...
- [ ] 5. **Enrich Mode C with `elementType` in DoclingExtractor ([req 2](spec.md#requirements))**
...
- [ ] 6. **Update Mode C tests ([req 2](spec.md#requirements))**
...
- [ ] 7. **Full test suite pass ([req 4](spec.md#requirements))**
